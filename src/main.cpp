...
uint256 hashGenesisBlock("0x171c52d0cd246bf563e297e601308a954f950a9436fb4ccc063d950bc6df754f");
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // adamcoin: 1 days
static const int64 nTargetSpacing = 120; // adamcoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal adamcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "adamcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1387425641; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 3140867;

        if (fTestNet)
        {
            block.nTime    = 1387425641;
            block.nNonce   = 440824;
        }
